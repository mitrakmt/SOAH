...
class GrayQuote extends Component {
  render() {
    return (
      <svg
        width="72px"
      ...
      >
        <defs>
          <rect x="333" y="779" width="32" height="42" id="rect-1" />
        </defs>
        <g
          id="Gray Quote"
          stroke="none"
          ...
          opacity="0.800334821"
        >
          <g id="Press-1" transform="translate(-338.000000, -779.000000)">
            <g id="Bitmap">
              <image
                x="333"
                y="779"
              ...
              />
              <use fill="transparent" fill-rule="evenodd" xlinkHref="#rect-1" />
            </g>
          </g>
        </g>
      </svg>
